...
+ (NSString *)ff_dateToTimeStr:(NSDate *)inputDate
{
   return  [self ff_dateToTimeStr:inputDate dateFormatter:@"yyyy-MM-dd HH:mm:ss Z"];
}

+ (NSString *)ff_dateToTimeStr:(NSDate *)inputDate dateFormatter:(NSString *)formatterDate
{
    NSDateFormatter *dateFormatter = [[NSDateFormatter alloc] init];
    [dateFormatter setDateFormat:formatterDate];
